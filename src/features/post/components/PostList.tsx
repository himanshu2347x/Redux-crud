  ...
  if (isLoading && posts.length === 0) {
    return (
      <div className="rounded-3xl border border-white/10 bg-slate-950/40 p-8 text-center text-slate-300 shadow-xl backdrop-blur">
        Loading posts from json-server...
      </div>
    )
  }

  return (
    <section className="min-h-0 flex-1 overflow-hidden rounded-3xl border border-white/10 bg-slate-950/30 p-3 shadow-xl backdrop-blur">
